...
AJ_Morpho_Manual.manova <- procD.lm(f1 = shape ~ individual+observer+iteration+iteration*camera, data = AJ_Manual_GDF, RRPP=TRUE, iter = 999, print.progress=FALSE)
...
CentroidSize_AOV <- aov(value ~ ID + Observer + Method + Observer*Camera, data = CentroidSize_Melt)
