...
AJ_Morpho_ManualAvg.manova <- procD.lm(shape~individual+observer, data = AJ_ManualAvg_GDF, print.progress = FALSE)
...
AJ_Morpho_Auto.manova <- procD.lm(shape~individual+observer, data = AJ_Auto_GDF, print.progress=FALSE)
...
Both_Morpho_MLvsAuto.manova <- procD.lm(shape ~ individual+method, data = Both_MLvsAuto_GDF, print.progress=FALSE)
