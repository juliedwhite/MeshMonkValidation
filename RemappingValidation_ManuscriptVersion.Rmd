...
AJ_Manual_Groups$Camera <- rep(c(rep("2005 3dMD 2-pod", each=14), "2014 3dMD 2-pod", rep("2014 3dMD 3-pod", each = 26)))
...
Both_MLvsAuto_Groups$Camera <- c(rep("2005 3dMD 2-pod", each=14), "2014 3dMD 2-pod", rep("2014 3dMD 3-pod", each = 26))
...
AJ_MLvsAuto_Groups$StudyID <- c(rep(unique(landmarks$ID)))
AJ_MLvsAuto_Groups$Camera <- c(rep("2005 3dMD 2-pod", each=14), "2014 3dMD 2-pod", rep("2014 3dMD 3-pod", each = 26))
AJ_MLvsAuto_Groups$Method <- c(rep("ML", each=82), rep("Auto", each=82))
AJ_MLvsAuto_Groups$Observer <- c(rep("AZ", each=41), rep("JW", each=41))
```
GPA align manual and automatic landmark iterations
```{r}
...
AJ_Morpho_MLvsAuto.manova <- procD.lm(shape ~ individual + method + camera + observer + individual*observer + individual*camera, data = AJ_MLvsAuto_GDF, iter = 999, RRPP=TRUE, print.progress=FALSE)
